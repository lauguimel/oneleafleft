...
def test_classify_feature_family() -> None:
    ...
    assert classify_feature_family("dist_to_road") == "infrastructure"
    assert classify_feature_family("defo_rate_500m_mean") == "contagion"
    assert classify_feature_family("ntl_mean_Lag3") == "night_lights"
    assert classify_feature_family("pa_pressure_ring") == "protected_areas"
