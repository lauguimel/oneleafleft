...
Figure~\ref{fig:ablation}(c) shows that extending the temporal window
...
(c)~Temporal ablation: PR-AUC as a function of lag-window depth
(1--4 years, blue line); orange squares show four encoding schemes
evaluated at comparable feature counts.}
\end{figure}
...
Colours indicate feature group: blue\,=\,spatial contagion or Hansen
local history; orange\,=\,climate/soil; green\,=\,infrastructure
or demography.}
\end{figure}
